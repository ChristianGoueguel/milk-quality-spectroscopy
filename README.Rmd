...
The color gradient shows multivariate outliers, i.e. samples that are unusual when considering all targets together. Blue points (high Mahalanobis distance) indicate values that are potantial outliers in the multivariate space, even if they might not be extreme outliers in individual targets.
